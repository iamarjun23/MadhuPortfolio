  ...
  room: RoomSchema.parse({
    ...
    cards: [
      ...
      },
      {
        ...
        color: "ember",
        kicker: "Reading",
        text: "Zero to Viral, Sharan Hegde — whose reels I used to cut.",
      },
      {
        id: "romance-novels",
        type: "note",
        ...
        color: "signal",
        kicker: "Otherwise",
        text: "Romance novels, unapologetically.",
      },
      {
        id: "motion-graphics",
        type: "note",
        ...
        pinType: "pin",
        color: "ember",
        kicker: "Currently bad at",
        text: "Motion graphics. Working on it.",
      },
      {
        id: "bike-pov",
        type: "note",
      ...
      },
      {
        ...
        tint: "rg4",
        tag: "Cover",
        caption: "Kun Faya Kun",
        subCaption: "Sung & recorded",
      },
      {
        id: "mast-malang",
        type: "video",
      ...
      },
      {
        ...
        tag: "Cover",
        caption: "Gerua",
        subCaption: "Sung & recorded (title tbc)",
      },
    ],
  }),
